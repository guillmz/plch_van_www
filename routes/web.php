...
// Only allow managing 2FA if AUTHY_KEY is defined inside .env file
    ...
    // Route::resource('products/units', 'UnitController');

    Route::get('products/units/', [
        'as' => 'unit.index',
        'uses' => 'UnitController@index'
    ]);

    Route::get('products/units/{unit}/edit', [
        'as' => 'unit.edit',
        'uses' => 'UnitController@edit'
    ]);

    Route::delete('products/units/{unit}/delete', [
        'as' => 'unit.delete',
        'uses' => 'UnitController@destroy'
    ]);

    Route::get('products/units/create', [
        'as' => 'unit.create',
        'uses' => 'UnitController@create'
    ]);

    Route::post('products/units/create', [
        'as' => 'unit.store',
        'uses' => 'UnitController@store'
    ]);

    Route::put('products/units/{unit}/update', [
        'as' => 'unit.update',
